...
const ConductorForm = ({ isOpen, onClose, onSuccess, initialValues }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                id_Conductor: initialValues ? initialValues.id_Conductor : 0
            };

            if (initialValues) {
                await agent.Conductores.update(initialValues.id_Conductor, payload);
            } else {
                await agent.Conductores.create(payload);
            }
            onSuccess();
            onClose();
        } catch (error) {
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                <div className="bg-blue-600 px-6 py-4 flex justify-between items-center">
                    <h3 className="text-xl font-bold text-white">
                        {initialValues ? 'Editar Conductor' : 'Nuevo Conductor'}
                    </h3>
